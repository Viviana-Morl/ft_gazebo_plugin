   ...
   ignition::msgs::Set(markerMsg2.add_point(),
    ...
    {  
     ...
     double z=50;
      ...
      _back_right_lowerleg->AddForceAtRelativePosition(ignition::math::Vector3d( x_dist.data,0,0),ignition::math::Vector3d(0, 0 ,0));
...
/*if (currTime.Double()==2)
   ...
   _distx_pub_fr.publish( x_dist_n );
     _disty_pub_fr.publish( y_dist_n );
      ...
      //if (currTime>=2.93 && currTime<=3.04 ) {
      //_back_right_lowerleg = model->GetLink("back_left_lowerleg");
      //_back_right_lowerleg->AddForceAtRelativePosition(ignition::math::Vector3d(0,0,0),ignition::math::Vector3d(0,-0.0,-0));
     // }
...
_back_right_lowerleg = model->GetLink("back_left_upperleg");
 ...
 //_back_right_lowerleg->AddForceAtRelativePosition(ignition::math::Vector3d(x_dist.data,y_dist.data,0),ignition::math::Vector3d(0,0,0));
    _back_right_lowerleg->AddForceAtRelativePosition(ignition::math::Vector3d(x_dist.data,y_dist.data,0),ignition::math::Vector3d(0,0,-0.32));
